...
const STRINGS = {
  ...
  'pt-BR': {
    ...
    'auth.login.toRegister':   'CADASTRAR-SE',
    'auth.login.guest':        'JOGAR SEM LOGIN',

    'auth.register.title':     '⚔ CADASTRAR-SE',
    ...
    'complete.menu':           'MENU PRINCIPAL',

    'victory.title':           '⚔ MISSÃO CUMPRIDA ⚔',
    'victory.menu':            '► MENU PRINCIPAL',
